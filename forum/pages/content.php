...
<body>
  <!-- Navigation -->
  <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color : #3c2c3e;">
    <div class="container">
      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="home.php">Infocorn Forum</a>
      </div>
  ...
  <div class="container" style="margin:7% auto;">
    <h4 style="color:white;">Latest Discussion</h4>
    <hr>
    ...
    <div class="col-sm-5 col-md-5 sidebar">
      ...
      <form method="POST">
        ...
        <input type="submit" id="save" class="btn btn-success pull-right btn-danger" value="Comment">
      </form>
    </div>
  </div>
  ...
  <div class="my-quest" id="quest">
    <div>
      <form method="POST" action="question-function.php">
        ...
        <br>
        <input type="submit" class="btn btn-success pull-right btn-danger" value="Post">
      </form><br>
      <hr>
